...
const errList = ["a","b",false,"c","","d"];
const myList = ["red","blue","green","yellow","yellow","pink"]
const addList = ["white","black","pink","pink"]

// const newList = _.chunk(myList, 3);
// const newList = _.compact(errList);
// const newList = _.concat(addList, "red", ["green"], [["blue"]]);
// const newList = _.difference(myList, ["yellow", "red"]);
...
const result = _.differenceWith(students, [students.name, 'Boldoo'], _.isEqual);
